...
void Create(){
    int pilCreate;
    printf("====================================\n");
    printf("| Input Data Toko Roti Cake Bakery |\n");
    printf("====================================\n");
    printf("| 1. Roti                          |\n");
    printf("| 2. Admin                         |\n");
    printf("| 3. Pelanggan                     |\n");
    printf("| 4. Pembayaran                    |\n");
    printf("====================================\n");
    printf("Masukan pilihan data yang ingin diinputkan: ");
    scanf("%d",&pilCreate);
    switch (pilCreate)
    {
        case 1:
            checkdupe:
            printf("\n===============================\n");
            printf("| Input Data Roti Cake Bakery |");
            printf("===============================\n");
        ...
        case 2:
            checkdupe2:
            printf("\n================================\n");
            printf("| Input Data Admin Cake Bakery |");
            printf("================================\n");
        ...
        case 3:
            checkdupe3:
            printf("\n====================================\n");
            printf("| Input Data Pelanggan Cake Bakery |");
            printf("====================================\n");
        ...
        case 4:
            checkdupe4:
            printf("\n=====================================\n");
            printf("| Input Data Pembayaran Cake Bakery |");
            printf("=====================================\n");
